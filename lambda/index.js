...
const StrokeRiskIntentHandler = {
    ...
    handle(handlerInput) {
        ...
        if (Alexa.getIntentName(handlerInput.requestEnvelope) === 'StrokeRiskIntent') {
            ...
            if(!age) {
                speakOutput = `Please provide a number as your age?`;
...
const HypertensionRiskIntentHandler = {
    ...
    handle(handlerInput) {
        ...
        if (Alexa.getIntentName(handlerInput.requestEnvelope) === 'HypertensionRiskIntent') {
            ...
            if (!sbp) {
                speakOutput = `Please enter a number as systolic blood pressure?`;
            ...
            if (!dbp) {
                speakOutput = `Please enter a number as Diastolic Blood Pressure?`;
            ...
            if (!hr) {
                speakOutput = `Please enter a number as heart rate?`;
            ...
            if (sbp >= 110 && sbp <= 119 && dbp >= 70 && dbp <= 79) {
                speakOutput = speakOutput + `Your blood pressure readings are NORMAL`;
            } else if (sbp >= 120 && sbp <= 129 && dbp >= 70 && dbp <= 79) {
                speakOutput = speakOutput + `You have LOW risk of HYPERTENSION. Please consult a physician`;
            } else if (sbp >= 180 || dbp >= 120) {
                speakOutput = speakOutput + `You have risk of HYPERTENSIVE CRISIS. Please consult a physician immediately`;
            } else if (sbp >= 140 && sbp <= 179 || dbp >= 90 && dbp <= 119) {
                speakOutput = speakOutput + `You have HIGH risk of HYPERTENSION. Please consult a physician immediately`;
            } else if (sbp >= 130 && sbp <= 139 || dbp >= 80 && dbp <= 89) {
                speakOutput = speakOutput + `You have MEDIUM risk of HYPERTENSION. Please consult a physician`;
            } else if (sbp < 110 || dbp < 70) {
                speakOutput = speakOutput + `You may have HYPOTENSION. Please consult a physician`;
            }
